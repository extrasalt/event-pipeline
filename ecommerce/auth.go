...
var jwtSecret = []byte("mable-demo-secret-change-in-production")
...
func handleSignup(c *gin.Context) {
	...
	users.users[req.Email] = User{Email: req.Email, Name: req.Name, Password: req.Password}
...
func handleLogin(c *gin.Context) {
	...
	users.mu.RLock()
	user, exists := users.users[req.Email]
	users.mu.RUnlock()
